...
namespace AOSharp.Core
{
    internal class ChatWindowNode_t
    {
        ...
        internal static ChatAppendTextSimpleDelegate AppendText = Marshal.GetDelegateForFunctionPointer<ChatAppendTextSimpleDelegate>(Kernel32.GetModuleHandle("GUI.dll") + 0x9BD4C); 
    }
}
